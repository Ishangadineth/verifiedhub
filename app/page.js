...
const translations = {
    ...
    ta: {
        ...
        scamTypes: {
            ...
            titleSpan: "மற்றும் திருட்டுக்கள்",
        ...
        malware: {
            title: "Malware & Threat",
            titleSpan: "விளக்கம்",
            virus: { title: "கணினி வைரஸ்", desc: "ஏனைய மென்பொருட்களுடன் இணைந்து கணினியைப் பாதிக்கும் தீங்குவிளைவிக்கும் குறியீடுகள்." },
            worms: { title: "வோர்ம்ஸ் (Worms)", desc: "வலைப்பின்னல்கள் மூலம் தானாகப் பரவி பாதிப்பை ஏற்படுத்தும் மென்பொருட்கள்." },
            spyware: { title: "ஸ்பைவெயார் (Spyware)", desc: "உங்கள் தரவுகளை இரகசியமாகக் கண்காணித்துத் திருடும் மென்பொருட்கள்." },
            adware: { title: "அட்வெயார் (Adware)", desc: "தேவையற்ற விளம்பரங்களைக் காட்டி கணினியை மந்தமாக்கும் மென்பொருட்கள்." },
            bots: { title: "Bots & Botnets", desc: "சைபர் தாக்குதல்களுக்காக ஹேக்கர்களால் பயன்படுத்தப்படும் பாதிக்கப்பட்ட கணினி வலைப்பின்னல்கள்." },
            hijacker: { title: "Browser Hijacker", desc: "உங்கள் உலாவியின் தேடல் இயந்திரத்தை அனுமதியின்றி மாற்றும் மென்பொருட்கள்." },
            hacker: { title: "ஹேக்கர்கள் (Hackers)", desc: "அனுமதியின்றி கணினி அமைப்புகளுக்குள் நுழையும் நபர்கள்." },
        ...
        <>
            <nav suppressHydrationWarning>
                ...
                <ul className={`nav-links ${isMenuOpen ? 'active' : ''}`}>
                    ...
                    <li><button onClick={toggleLanguage} className="lang-switch-btn"><Globe size={16} /> {displayLang.toUpperCase()}</button></li>
                </ul>
            ...
            {!isMenuOpen && (
                <button onClick={toggleLanguage} className="mobile-lang-fab lang-switch-btn">
